...
class PineappleDataset(Dataset):
    def __init__(self, train=True, train_ratio=0.8, resize_img=256, path="/home/rtxmsi1/Documents/VAE_training-master/FULL_VERTICAL_PINEAPPLE/FULL_UNIFIED"):
        # Get all images sorted from the specified folder.
        self.all_images = sorted(glob.glob("{0}/*".format(path)))
